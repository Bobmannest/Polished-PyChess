...
def selected_tile_available_move_visuals():
    for row in board:
        for tile in row:
            available_moves = temp_selected_piece.get_available_moves(temp_selected_piece,
                                                                      temp_selected_tile.get_position(), board)
